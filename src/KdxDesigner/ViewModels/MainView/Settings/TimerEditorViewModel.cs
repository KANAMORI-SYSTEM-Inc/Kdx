...
namespace KdxDesigner.ViewModels
{
    public partial class TimerEditorViewModel : ObservableObject
    {
        ...
        private void ViewMnemonicTimerDevices()
        {
            ...
            var dialog = new ViewsToolsTimer.MnemonicTimerDeviceView(_repository, _mainViewModel);
        ...
        private void EditRecordIds()
        {
            ...
            // RecordIds編集ダイアログを開く
            var dialog = new ViewsToolsTimer.RecordIdsEditorDialog(SelectedTimer, _repository, plcId);
            var mainWindow = Application.Current.Windows.OfType<MainView>().FirstOrDefault();
            if (mainWindow != null)
            {
                dialog.Owner = mainWindow;
